...
//        }
//
//        int m = (tree[index].left + tree[index].right) >> 1;
//        if (left > m) {
//            changeOccupy(index * 2 + 1, left,right, flag);
//        } else if (right <= m) {
//            changeOccupy(index * 2, left, right, flag);
//        } else {
//            changeOccupy(index * 2, left, m, flag);
//            changeOccupy(index * 2 + 1, m + 1, right, flag);
//        }
//
//        nodeB leftChild = tree[2*index], rightChild = tree[2*index+1];
//        // Case02 Fully Inside
